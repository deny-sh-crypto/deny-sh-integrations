...
OpenAI Agents SDK, LlamaIndex, CrewAI, Pydantic-AI, AutoGen, n8n. Each wraps
`createVaultResolver` / `create_vault_resolver`. Add a "coming soon" badge to any
framework page that gains a package install snippet before its package ships.
